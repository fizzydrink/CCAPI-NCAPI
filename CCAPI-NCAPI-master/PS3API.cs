            ...
            private string strTraduction(string keyword)
            {
                if (getSysLanguage() == Lang.French)
                {
                    switch (keyword)
                    {
                        ...
                        case "noConsole": return "Aucune console disponible, démarrez CCAPI Manager (v2.8) et ajoutez une nouvelle console.";
                ...
                else
                {
                    switch (keyword)
                    {
                        ...
                        case "noConsole": return "None consoles available, run CCAPI Manager (v2.8) and add a new console.";
